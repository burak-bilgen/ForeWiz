...
final class PerformanceMonitor {
    ...
    private let queue = DispatchQueue(label: "com.weathra.performance", qos: .utility)
...
final class DiskCache {
    ...
    private let queue = DispatchQueue(label: "com.weathra.diskcache", qos: .utility)
...
final class ImageCache {
    ...
    private let queue = DispatchQueue(label: "com.weathra.imagecache", qos: .utility)
